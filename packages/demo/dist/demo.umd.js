(function (global, factory) {
	...
	var lunchtime = createCommonjsModule(function (module, exports) {
	"use strict";
	...
	var lunchtime$1 = unwrapExports(lunchtime);

	var millisecondsUntil_1 = createCommonjsModule(function (module, exports) {
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var millisecondsUntil = unwrapExports(millisecondsUntil_1);
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var ms_1 = __importDefault(ms);
	var lunchtime_1 = __importDefault(lunchtime);
	var millisecondsUntil_1$1 = __importDefault(millisecondsUntil_1);
	function howLongUntilLunch(hours, minutes) {
	    ...
	    if (minutes === undefined)
	        minutes = 30;
	    var millisecondsUntilLunchTime = millisecondsUntil_1$1.default(lunchtime_1.default(hours, minutes));
